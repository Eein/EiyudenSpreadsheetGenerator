...
import FieldMapTable from './DataTables/FieldMapTable.json' assert { type: 'json' };
import FieldTable from './DataTables/FieldTable.json' assert { type: 'json' };
import FieldText_Shared_Data from './localization_en_shared/FieldText Shared Data.json' assert { type: 'json' };
import FieldText_en from './localization_en/MonoBehaviour/FieldText_en.json' assert { type: 'json' };
